...
| `public/models/meshy/gatehouse.glb` | Meshy AI, generated by Ben 2026-08-06 (image-to-3D, from the GATE.md §5 prompt) — static, no rig | Meshy plan grant — as above | No |
...
Simplified from Meshy's raw 188,970 triangles to 2,822 (`gltf-transform simplify
--ratio 0.015 --error 0.01`), texture 2048² JPEG → 512² webp, 7.84 MB → 0.09 MB
all in. Facing +Z confirmed visually in `inspect.html`: the door-and-banners face
points at the game camera.
