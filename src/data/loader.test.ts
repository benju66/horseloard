...
describe('seed data', () => {
  it('validates clean', () => {
    ...
    expect(data.enemies.enemies.map((e) => e.id)).toEqual(['grunt', 'runner', 'brute', 'shieldbearer', 'swarm', 'wolf-rider', 'raven', 'looter', 'outrider', 'halberdier', 'sapper', 'juggernaut', 'warden', 'stalker', 'warlord']);
